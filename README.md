...
```js
import {JsonHigh} from 'https://deno.land/x/jsonhilo@v0.4.2-alpha/mod.js'
```

Or from a CDN such as [jsDelivr](https://www.jsdelivr.com/):

```js
import {JsonHigh} from 'https://cdn.jsdelivr.net/gh/xtao-org/jsonhilo@v0.4.2-alpha/mod.js'
```
